...
const experiences: Experience[] = [
  {
    ...
    description: [
      "Built NLP & Computer Vision pipelines using TensorFlow and PyTorch.",
      "Improved model inference speed by 30% via containerization (Docker, Kubernetes).",
      "Integrated CI/CD with GitHub Actions → Vercel for demos.",
    ],
  ...
  },
  {
    ...
    description: [
      "Worked on data collection & labeling for machine learning models.",
      "Performed feature engineering to improve model accuracy.",
      "Assisted in model training and API development.",
      "Reduced bug rate by 15% through comprehensive testing.",
    ],
    logo: "/placeholder.svg?height=80&width=80",
  },
]
